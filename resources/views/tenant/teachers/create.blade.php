...
<div class="p-8">
    <div class="max-w-6xl mx-auto">
        ...
        <div class="mb-6 flex items-center justify-between">
            <div>
                <h1 class="text-3xl font-bold text-gray-900">নতুন শিক্ষক যোগ করুন</h1>
                <p class="text-gray-600 mt-1">শিক্ষকের সম্পূর্ণ তথ্য পূরণ করুন</p>
            </div>
        ...
        <form action="{{ route('tenant.teachers.store') }}" method="POST" enctype="multipart/form-data">
            @csrf
            ...
            <div class="bg-white rounded-2xl shadow-lg p-8 mb-6">
                ...
                <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                    ...
                    <div>
                        ...
                        <input type="text" name="name_bn" required class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-green-500 focus:border-transparent" placeholder="যেমন: মোহাম্মদ রহিম">
                    </div>

                    <div>
                        <label class="block text-sm font-medium text-gray-700 mb-2">শিক্ষকের নাম (ইংরেজি) *</label>
                        <input type="text" name="name_en" required class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-green-500 focus:border-transparent" placeholder="e.g: Mohammad Rahim">
                    </div>

                    <div>
                        <label class="block text-sm font-medium text-gray-700 mb-2">জন্ম তারিখ *</label>
                        <input type="date" name="date_of_birth" required class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-green-500 focus:border-transparent">
                    </div>
                    ...
                    <div>
                        ...
                        <input type="text" name="birth_certificate" class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-green-500 focus:border-transparent">
                    </div>

                    <div>
                        <label class="block text-sm font-medium text-gray-700 mb-2">মোবাইল নম্বর</label>
                        <input type="text" name="mobile" class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-green-500 focus:border-transparent" placeholder="01XXXXXXXXX">
                    </div>
                    ...
                    <div>
                        ...
                        <select name="present_division" id="present_division" required class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-green-500 focus:border-transparent" onchange="loadDistricts('present')">
                            <option value="">নির্বাচন করুন</option>
                        </select>
                    </div>
                    ...
                    <div>
                        ...
                        <select name="present_district" id="present_district" required class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-green-500 focus:border-transparent" onchange="loadUpazilas('present')">
                    ...
                    <div>
                        ...
                        <select name="present_upazila" id="present_upazila" required class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-green-500 focus:border-transparent" onchange="loadUnions('present')">
                    ...
                    <div>
                        ...
                        <select name="present_union" id="present_union" class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-green-500 focus:border-transparent">
                    ...
                    <div class="md:col-span-2">
                        ...
                        <input type="text" name="present_address_details" required class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-green-500 focus:border-transparent" placeholder="বিস্তারিত ঠিকানা লিখুন">
                    </div>
                    ...
                    <div class="md:col-span-3 mt-6">
                        <div class="flex items-center gap-3 mb-4">
                            ...
                            <label class="flex items-center gap-2 cursor-pointer">
                                <input type="checkbox" id="sameAsPresent" onchange="copyPresentAddress()" class="w-4 h-4 text-green-600 rounded">
                    ...
                    <div>
                        <label class="block text-sm font-medium text-gray-700 mb-2">বিভাগ *</label>
                        <select name="permanent_division" id="permanent_division" required class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-green-500 focus:border-transparent" onchange="loadDistricts('permanent')">
                            <option value="">নির্বাচন করুন</option>
                        </select>
                    </div>
                    ...
                    <div>
                        <label class="block text-sm font-medium text-gray-700 mb-2">জেলা *</label>
                        <select name="permanent_district" id="permanent_district" required class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-green-500 focus:border-transparent" onchange="loadUpazilas('permanent')">
                            <option value="">প্রথমে বিভাগ নির্বাচন করুন</option>
                        </select>
                    </div>
                    ...
                    <div>
                        <label class="block text-sm font-medium text-gray-700 mb-2">উপজেলা *</label>
                        <select name="permanent_upazila" id="permanent_upazila" required class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-green-500 focus:border-transparent" onchange="loadUnions('permanent')">
                            <option value="">প্রথমে জেলা নির্বাচন করুন</option>
                        </select>
                    </div>
                    ...
                    <div>
                        <label class="block text-sm font-medium text-gray-700 mb-2">ইউনিয়ন</label>
                        <select name="permanent_union" id="permanent_union" class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-green-500 focus:border-transparent">
                            <option value="">প্রথমে উপজেলা নির্বাচন করুন</option>
                        </select>
                    </div>
                    ...
                    <div class="md:col-span-2">
                        <label class="block text-sm font-medium text-gray-700 mb-2">গ্রাম/রাস্তা/বাড়ি নম্বর *</label>
                        <input type="text" name="permanent_address_details" id="permanent_address_details" required class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-green-500 focus:border-transparent" placeholder="বিস্তারিত ঠিকানা লিখুন">
                    </div>
                </div>
            </div>
            ...
            <div class="bg-white rounded-2xl shadow-lg p-8 mb-6">
                ...
                <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                    <div>
                        ...
                        <input type="date" name="admission_date" required class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-green-500 focus:border-transparent">
                    </div>

                    <div>
                        <label class="block text-sm font-medium text-gray-700 mb-2">রোল নম্বর *</label>
                        <input type="text" name="roll_number" required class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-green-500 focus:border-transparent">
                    </div>

                    <div>
                        <label class="block text-sm font-medium text-gray-700 mb-2">শিক্ষক আইডি</label>
                        <input type="text" name="student_id" class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-green-500 focus:border-transparent" placeholder="স্বয়ংক্রিয়ভাবে তৈরি হবে">
                    </div>

                    <div>
                        <label class="block text-sm font-medium text-gray-700 mb-2">ক্লাস *</label>
                        <select name="class" required class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-green-500 focus:border-transparent">
                            <option value="">নির্বাচন করুন</option>
                            <option value="1">প্রথম শ্রেণী</option>
                            <option value="2">দ্বিতীয় শ্রেণী</option>
                            <option value="3">তৃতীয় শ্রেণী</option>
                    ...
                    <div>
                        ...
                        <select name="section" required class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-green-500 focus:border-transparent">
                            <option value="">নির্বাচন করুন</option>
                            <option value="A">A</option>
                            <option value="B">B</option>
                    ...
                    <div>
                        ...
                        <select name="shift" class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-green-500 focus:border-transparent">
                            <option value="">নির্বাচন করুন</option>
                    ...
                    <div>
                        ...
                        <select name="academic_year" required class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-green-500 focus:border-transparent">
                            <option value="">নির্বাচন করুন</option>
                    ...
                    <div>
                        ...
                        <input type="text" name="previous_school" class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-green-500 focus:border-transparent">
                    </div>

                    <div>
                        <label class="block text-sm font-medium text-gray-700 mb-2">ট্রান্সপোর্ট সুবিধা</label>
                        <select name="transport" class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-green-500 focus:border-transparent">
                    ...
                    <div>
                        ...
                        <select name="hostel" class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-green-500 focus:border-transparent">
                            <option value="no">না</option>
                            <option value="yes">হ্যাঁ</option>
                        </select>
                    </div>
            ...
            <div class="bg-white rounded-2xl shadow-lg p-8 mb-6">
                ...
                <div class="grid grid-cols-1 md:grid-cols-3 gap-6 mb-6">
                    <div>
                        ...
                        <input type="text" name="father_name" required class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-green-500 focus:border-transparent">
                    </div>

                    <div>
                        <label class="block text-sm font-medium text-gray-700 mb-2">পিতার মোবাইল *</label>
                        <input type="text" name="father_mobile" required class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-green-500 focus:border-transparent" placeholder="01XXXXXXXXX">
                    </div>

                    <div>
                        <label class="block text-sm font-medium text-gray-700 mb-2">পিতার পেশা</label>
                        <input type="text" name="father_occupation" class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-green-500 focus:border-transparent">
                    </div>

                    <div>
                        <label class="block text-sm font-medium text-gray-700 mb-2">পিতার এনআইডি</label>
                        <input type="text" name="father_nid" class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-green-500 focus:border-transparent">
                    </div>

                    <div>
                        <label class="block text-sm font-medium text-gray-700 mb-2">পিতার ইমেইল</label>
                        <input type="email" name="father_email" class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-green-500 focus:border-transparent">
                    </div>

                    <div>
                        <label class="block text-sm font-medium text-gray-700 mb-2">পিতার বার্ষিক আয়</label>
                        <input type="text" name="father_income" class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-green-500 focus:border-transparent">
                    </div>
                </div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-3 gap-6 mb-6">
                    <div>
                        ...
                        <input type="text" name="mother_name" required class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-green-500 focus:border-transparent">
                    </div>

                    <div>
                        <label class="block text-sm font-medium text-gray-700 mb-2">মাতার মোবাইল</label>
                        <input type="text" name="mother_mobile" class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-green-500 focus:border-transparent" placeholder="01XXXXXXXXX">
                    </div>

                    <div>
                        <label class="block text-sm font-medium text-gray-700 mb-2">মাতার পেশা</label>
                        <input type="text" name="mother_occupation" class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-green-500 focus:border-transparent">
                    </div>

                    <div>
                        <label class="block text-sm font-medium text-gray-700 mb-2">মাতার এনআইডি</label>
                        <input type="text" name="mother_nid" class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-green-500 focus:border-transparent">
                    </div>

                    <div>
                        <label class="block text-sm font-medium text-gray-700 mb-2">মাতার ইমেইল</label>
                        <input type="email" name="mother_email" class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-green-500 focus:border-transparent">
                    </div>
                </div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                    <div>
                        ...
                        <input type="text" name="guardian_name" class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-green-500 focus:border-transparent">
                    </div>

                    <div>
                        <label class="block text-sm font-medium text-gray-700 mb-2">অভিভাবকের মোবাইল</label>
                        <input type="text" name="guardian_mobile" class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-green-500 focus:border-transparent" placeholder="01XXXXXXXXX">
                    </div>

                    <div>
                        <label class="block text-sm font-medium text-gray-700 mb-2">সম্পর্ক</label>
                        <input type="text" name="guardian_relation" class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-green-500 focus:border-transparent" placeholder="যেমন: চাচা, মামা">
                    </div>

                    <div class="md:col-span-3">
                        <label class="block text-sm font-medium text-gray-700 mb-2">অভিভাবকের ঠিকানা</label>
                        <textarea name="guardian_address" rows="2" class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-green-500 focus:border-transparent"></textarea>
                    </div>
                </div>
            </div>
            ...
            <div class="bg-white rounded-2xl shadow-lg p-8 mb-6">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div>
                        ...
                        <select name="special_needs" class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-green-500 focus:border-transparent">
                            <option value="no">না</option>
                            <option value="yes">হ্যাঁ</option>
                        </select>
                    </div>
                    ...
                    <div>
                        ...
                        <input type="text" name="health_condition" class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-green-500 focus:border-transparent" placeholder="যদি থাকে">
                    </div>

                    <div>
                        <label class="block text-sm font-medium text-gray-700 mb-2">জরুরি যোগাযোগ নম্বর *</label>
                        <input type="text" name="emergency_contact" required class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-green-500 focus:border-transparent" placeholder="01XXXXXXXXX">
                    </div>
                    ...
                    <div class="md:col-span-2">
                        ...
                        <textarea name="remarks" rows="3" class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-green-500 focus:border-transparent" placeholder="অতিরিক্ত কোনো তথ্য থাকলে লিখুন"></textarea>
                    </div>
                </div>
            </div>
            ...
            <div class="bg-white rounded-2xl shadow-lg p-8 mb-6">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div>
                        ...
                        <div class="relative">
                            <input type="file" name="birth_certificate_file" accept="image/*,.pdf" class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-green-500 focus:border-transparent" onchange="previewDocument(event, 'birth_cert_preview')">
                    ...
                    <div>
                        ...
                        <div class="relative">
                            <input type="file" name="vaccination_card" accept="image/*,.pdf" class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-green-500 focus:border-transparent" onchange="previewDocument(event, 'vaccine_preview')">
                            <p class="text-xs text-gray-500 mt-1">PDF বা Image (Max: 2MB)</p>
                        </div>
                    ...
                    <div>
                        ...
                        <div class="relative">
                            <input type="file" name="father_nid_file" accept="image/*,.pdf" class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-green-500 focus:border-transparent" onchange="previewDocument(event, 'father_nid_preview')">
                            <p class="text-xs text-gray-500 mt-1">PDF বা Image (Max: 2MB)</p>
                        </div>
                    ...
                    <div>
                        ...
                        <div class="relative">
                            <input type="file" name="mother_nid_file" accept="image/*,.pdf" class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-green-500 focus:border-transparent" onchange="previewDocument(event, 'mother_nid_preview')">
                            <p class="text-xs text-gray-500 mt-1">PDF বা Image (Max: 2MB)</p>
                        </div>
                    ...
                    <div>
                        ...
                        <div class="relative">
                            <input type="file" name="previous_school_certificate" accept="image/*,.pdf" class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-green-500 focus:border-transparent" onchange="previewDocument(event, 'prev_school_preview')">
                            <p class="text-xs text-gray-500 mt-1">PDF বা Image (Max: 2MB)</p>
                        </div>
                    ...
                    <div>
                        ...
                        <div class="relative">
                            <input type="file" name="other_documents" accept="image/*,.pdf" class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-green-500 focus:border-transparent" onchange="previewDocument(event, 'other_doc_preview')">
                            <p class="text-xs text-gray-500 mt-1">PDF বা Image (Max: 2MB)</p>
                        </div>
                ...
                <div class="mt-4 p-4 bg-green-50 border border-blue-200 rounded-lg">
            ...
            <div class="bg-white rounded-2xl shadow-lg p-8">
                <div class="flex items-center justify-between">
                    <a href="{{ route('tenant.teachers.index') }}" class="bg-gray-200 hover:bg-gray-300 text-gray-700 px-8 py-3 rounded-xl font-bold transition-colors flex items-center gap-2">
                        <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
...
const getApiUrl = (endpoint) => {
    // Extract the main domain from current URL
    const hostname = window.location.hostname;
    const parts = hostname.split('.');
    
    // If it's a subdomain (tenant), use the main domain
    let baseDomain;
    if (parts.length > 2) {
        // It's a subdomain like iqranooraniacademy.smartpathshala.test
        baseDomain = parts.slice(-2).join('.'); // smartpathshala.test
        return `http://${baseDomain}${endpoint}`;
    } else {
