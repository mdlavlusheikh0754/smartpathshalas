...
return new class extends Migration
{
    ...
    {
        if (Schema::connection('central')->hasTable('fee_collections')) {
            return;
        }
        Schema::connection('central')->create('fee_collections', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::connection('central')->dropIfExists('fee_collections');
    }
};
