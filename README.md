...
```bash
# Clone repository
git clone https://github.com/Lavlu224/smartpathshala.git
cd smartpathshala
...
**Lavlu Sheikh**
- GitHub: [@Lavlu224](https://github.com/Lavlu224)
- Repository: [smartpathshala](https://github.com/Lavlu224/smartpathshala)
